...
function AdminData() {
      ...
      .then((employees) => {
        ...
        if (admin) {
          setAdminData({
            ...
            email: admin.email,
            roll: admin.roll,
            rollId: admin.rollId // Corrected access to 'roll id' property
          });
  ...
  return (
    <div>
      <div className='d-flex justify-content-between Mydata w-screen'>
        ...
        '><svg width="136" height="22" viewBox="0 0 136 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M25.3479 2.07227L30.9247 19.2221C31.345 20.5144 30.3817 21.8406 29.0227 21.8406H25.4501C24.143 21.8406 22.9864 20.9943 22.5908 19.7485L17.313 3.12631C16.8216 1.57872 17.9767 0 19.6004 0H22.4949C23.7943 0 24.946 0.836549 25.3479 2.07227Z" fill="#F8285A" />
            <path d="M18.4585 14.5335L14.4 1.53388C14.1152 0.621383 13.2702 0 12.3143 0C11.3835 0 10.6159 0.729443 10.5685 1.65907L10.0856 11.1365C10.0391 12.0484 10.1491 12.9616 10.4108 13.8364L12.3784 20.4138C12.6317 21.2605 13.4107 21.8406 14.2945 21.8406H15.8075C16.678 21.8406 17.4485 21.2775 17.713 20.4481L18.4476 18.1442C18.8218 16.9703 18.8257 15.7096 18.4585 14.5335Z" fill="#E9E9E9" />
            <path d="M9.14022 0H12.2457C13.864 0 15.0184 1.56893 14.537 3.11397L9.30894 19.8925C8.91832 21.146  1 7.75783 22 6.44476 22H2.91161C1.56815 22 0.606751 20.7018 0.998558 19.4167L6.27064 2.12509C6.65556 0.862609 7.82037 0 9.14022 0Z" fill="#F8285A" />
          </svg>
        </h1>
        ...
        <div style={{ position: 'relative', display: 'inline-block' }} className='my-div mb-2'>
          ...
          {showAdminInfo && storedAdminData && (
            <div style={{ position: 'absolute', top: '65px', left: '-110%', transform: 'translateX(-50%)', zIndex: '1', background: '#fff', padding: '0', boxShadow: '0 0 10px rgba(0,0,0,0.1)' }} className='AdminData menu-title text-sm font-semibold text-gray-700 menu-item-active:text-primary menu-link-hover:!text-primary'>
              <div className=''>
