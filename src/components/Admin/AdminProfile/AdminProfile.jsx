...
function AdminProfile() {
  ...
  const handleProfileClick = (e) => {
    ...
    setShowAdminInfo(prevState => !prevState); // Toggle the profile info
  };
  ...
  return (
    <div className='px-2'>
      <div className='d-flex justify-content-between Mydata '>
        <h1 className='text-2xl font-bold hidden md:block ml-10 text-center mt-4 mb-4'>
              ...
              <div className=''>
                <div className='d-flex'>
                  ...
                  <div className='MyProfile ml-4 MyAdminsss'>
                    <p className='hover:rounded hover:cursor-pointer hover:text-white hover:bg-blue-600 MyName'>{storedUserName}</p>
                    <p className='myEmail'>{storedUserEmail}</p>
                    <span className='myEmail MyRoll'>{storedUserRole}</span>
                  </div>
                </div>
                ...
                <div className='MyAdminss ml-2 mt-0'>
                  <li className='flex items-center p-2 py-3 space-x-4 hover:rounded hover:cursor-pointer hover:bg-blue-600 hover:text-white Myli'>
                    ...
                    <span className='md:inline'>My profile</span>
                  </li>
