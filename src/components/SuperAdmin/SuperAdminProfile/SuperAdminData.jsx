  ...
  return (
    <div>
      <div className='d-flex justify-content-between Mydata'>
        ...
        <div style={{ position: 'relative', display: 'inline-block' }} className='my-div mb-2 MyNav' ref={profileRef}>
          <img
              ...
              <div className=''>
                <div className='d-flex ml-2 '>
                  ...
                  <div className='MyProfile ml-4 MyAdminsss'>
                    <p className='hover:rounded hover:cursor-pointer hover:text-white hover:bg-blue-600 MyName'>{storedAdminData.name}</p>
